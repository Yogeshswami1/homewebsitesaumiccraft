...
// import zero from '../../../assets/000.webp'; 

const FullPagePhoto = () => {
  return (
    <div style={{ position: 'relative', textAlign: 'center' }}>
      <img src="https://saumicbucket.s3.ap-south-1.amazonaws.com/homepage+folder/000.webp" alt="Poster" style={{ width: '100%', height: 'auto' }} />
