...
//   const contentRefs = useRef([]); // Array to hold refs for each answer
...
//   return (
//     <div className="w-full max-w-2xl mx-auto p-6" style={{paddingTop: '3rem'}}>
//       <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Frequently Asked Questions</h2>
//       {faqData.map((item, index) => (
//         <div key={index} className="mb-4">
//           <div
//             className="flex justify-between items-center bg-blue-100 p-4 rounded-lg cursor-pointer transition duration-300 ease-in-out hover:bg-blue-200"
...
const FAQ = () => {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, #f8fafc, #e4e8ec)',
      }}
    >
      <div className="w-full max-w-6xl bg-white shadow-lg rounded-lg p-6">
        ...
        {faqData.map((item, index) => (
          <div key={index} className="mb-4">
            <div
              className="flex justify-between items-center bg-gray-200 p-4 rounded-lg cursor-pointer transition-all duration-300 ease-in-out hover:bg-gray-300 shadow-sm"
              onClick={() => toggleQuestion(index)}
            >
            ...
            >
              <div className="mt-2 p-4 bg-gray-100 rounded-lg shadow-md text-gray-700">
                {item.answer}
              </div>
            </div>
          </div>
